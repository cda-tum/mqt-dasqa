...
class TestOptimalGeometryFinder:
    @patch("mqhad.optimal_geometry_finder.statistical_model.OptimalGeometryFinder")
    def test_find_optimal_geometry(self, mock_class1):
        ...
        optimal_geometry_finder.find_optimal_geometry = MagicMock(return_value=return_value)
