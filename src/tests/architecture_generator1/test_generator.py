...
from src.architecture_generator1.profile import Profile
from src.architecture_generator1.layout import Layout
from src.architecture_generator1.bus import Bus
from src.architecture_generator1.chip import Chip
...
class TestGenerator:
    ...
    def test_generate(self):
        with mock.patch(
            "src.architecture_generator1.yieldsimulator.YieldSimulator"
        ) as mock_class:
            from src.architecture_generator1.generator import Generator
    ...
    def test_init(self):
        from src.architecture_generator1.frequency import Frequency
        from src.architecture_generator1.generator import Generator
